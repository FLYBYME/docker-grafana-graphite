...
RUN     mkdir /src/grafana                                                                                    &&\
        mkdir /opt/grafana                                                                                    &&\
        wget https://github.com/fg2it/grafana-on-raspberry/releases/download/v4.0.0-beta2-testing/grafana-4.0.0-1479761438beta2.linux-armhf.tar.gz -O /src/grafana.tar.gz &&\
